          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 h-full">
            ...
            <div className="mt-12 p-6 bg-blue-50 rounded-xl border border-blue-100">
              ...
              <p className="text-blue-700 text-sm">
                For lost pet emergencies, please post directly to our <a href="/lost-and-found" className="underline font-medium hover:text-blue-800">Lost & Found</a> section for immediate community visibility.
              </p>
            </div>
          </div>
